...
for drive in win32api.GetLogicalDriveStrings().split('\000')[:-1]:#to get all the drives available in our system
    print(find_files("Text document.txt", drive))#here iam calling the method called find_files it walks through the all drive and displays that file particular path
